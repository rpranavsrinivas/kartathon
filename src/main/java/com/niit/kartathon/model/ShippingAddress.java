package com.niit.kartathon.model;

import java.util.UUID;  //for serialization 

import javax.persistence.Id; //annotations
...
public class ShippingAddress {
	...
	@NotBlank(message="Specify city") //error message that is thrown when no input is given
	private String city;
