...
<title>Online Travel Products Store</title>
</head>
<body>
<center><h1>Kartathon</h1>
<p>The site that gives you all products that you need during a travel.</p></center>
<nav class="navbar navbar-inverse ">
  <div class="container-fluid">
    <div class="navbar-header">
    
     <div class="navbar-brand">Kartathon</div>
    </div>
