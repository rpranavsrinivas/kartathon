//model must contain plain old java objects. ie bean class pojo class.. variable declaration. setter getter and setters
// no object creations.  hence we putit in model. 
