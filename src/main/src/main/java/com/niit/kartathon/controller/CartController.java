package com.niit.kartathon.controller;
...
import com.niit.kartathon.dao.CartDAO;
import com.niit.kartathon.dao.CartItemDAO;
import com.niit.kartathon.dao.ProductDAO;
import com.niit.kartathon.dao.UserDAO;
...
// to map a page to a particular url
	    @RequestMapping(value = "/addItem/{id}", method = RequestMethod.PUT)
	    @ResponseStatus(value = HttpStatus.NO_CONTENT)
	    public void addItem (@PathVariable(value ="id") String id, Principal username)  // principal is allotting the roles.
	    {
