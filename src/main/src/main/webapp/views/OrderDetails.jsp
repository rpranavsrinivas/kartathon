...
<title>order detail</title>
 <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
   ...
   <style type="text/css">
   body {
	background-image: url("https://www.google.co.in/url?sa=i&rct=j&q=&esrc=s&source=images&cd=&ved=0ahUKEwifx-GXzM7WAhVKr48KHWZ2Cu8QjRwIBw&url=http%3A%2F%2Fwww.ibedc-ng.com%2Fpay-your-bills%2F&psig=AOvVaw03cMWOe6XEb0tpEkPxbLq7&ust=1506918812273421.jpg");
...
<div  ng-app="addToCartApp"  ng-controller = "addToCartCtrl"  ng-init="retrieveCart('${cartId}')">
 ...
 cartApp.controller("addToCartCtrl", function ($scope, $http){
     ...
     $scope.removeItemFromCart = function (name) {
         $http.put('http://localhost:8080/kartathon/categoryDropdown/productDisplay/usercart/cart/removeItem/'+name).success(function (data) {
     ...
     $scope.addItemToCart = function (id) {
         $http['delete']('http://localhost:8080/kartathon/usercart/cart/addItem/'+id).success(function (data) {
     ...
     $scope.refreshCartItems = function () {
         $http.get('http://localhost:8080/kartathon/categoryDropdown/productDisplay/usercart/cart/refreshCart/'+$scope.cartId).success(function (data) {
            $scope.cart=data;
         });
     }; //choco
     ...
     $scope.clearCartItems = function () {
     	$http['delete']('http://localhost:8080/kartathon/categoryDropdown/productDisplay/usercart/cart/clearCartItems/'+$scope.cartId).success(function (data)
     			{$scope.refreshCartItems()
     		});
     };
 });
